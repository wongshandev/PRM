...
static SJYNotificateManger *sharedInstance=nil;


@implementation SJYNotificateManger
...
- (void)addLocalNotice {
    ...
    if (@available(iOS 10.0, *)) {
        ...
        content.sound = [UNNotificationSound soundNamed:@"notificationSound.caf"];
