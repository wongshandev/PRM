...
@interface DXCellDataAdapter : NSObject
...
/**
 *  DXCellDataAdapter's convenient method, used for UITableView.
 *
 ...
 *
 *  @return DXCellDataAdapter's object.
 */
...
/**
 *  DXCellDataAdapter's convenient method, used for UICollectionView.
 *
 *  @param cellReuseIdentifiers Cell's reused identifier.
 *  @param data                 Data, can be nil.
 *  @param cellType             Cell's type (The same cell, but maybe have different types).
 ...
 *  @return DXCellDataAdapter's object.
 */
+ (DXCellDataAdapter *)collectionDXCellDataAdapterWithCellReuseIdentifier:(NSString *)cellReuseIdentifiers data:(id)data
                                                             cellType:(NSInteger)cellType;
