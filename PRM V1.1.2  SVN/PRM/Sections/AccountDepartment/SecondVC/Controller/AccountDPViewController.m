...
@interface AccountDPViewController()<UITableViewDelegate,UITableViewDataSource>{
...
@implementation AccountDPViewController
...
//        make.edges.mas_equalTo(self.view);
           make.edges.mas_equalTo(self.view).mas_offset(UIEdgeInsetsMake(kTopStatusAndNavBarHeight, 0, 0, 0));
    }];
